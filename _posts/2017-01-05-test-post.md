...
## This is my first post on jekyll knitr and it is quite interesting and what a joy it is to use also. so here we go. I am finding this quite interesting.

So we will start by looking if jekyll is serving the site as expected
...
![plot of chunk unnamed-chunk-3](/figure/source/2017-01-05-test-post/unnamed-chunk-3-1.png)
